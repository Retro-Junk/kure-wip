...
void GetDirtyRect(int index, byte *kind, byte *x, byte *y, byte *w, byte *h, unsigned int *offs, byte newkind) {
...
int FindDirtyRectAndFree(byte kind, byte *x, byte *y, byte *w, byte *h, unsigned int *offs) {
	int i;
